      ...
      body: BlocConsumer<HospitalBloc, HospitalState>(
        ...
        builder: (context, state) {
          if (state is HospitalLoading || state is HospitalError) {
            ...
            return Responsive(
                mobile: HospitalMobile(hospitalModel: state.hospitalModel),
                tablet: HospitalTablet(hospitalModel: state.hospitalModel),
                desktop: HospitalDestop(hospitalModel: state.hospitalModel));
          } else if (state is HospitalError) {
